...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `Task(agent_type="oh-my-claudecode:code-reviewer", ...)` for cross-validation
...
- Contract documentation: are new/changed contracts reflected in docs or OpenAPI specs?
  ...
  <Style_Review_Mode>
    For lightweight style-only checks, code-reviewer also covers code style concerns:
