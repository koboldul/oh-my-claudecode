...
<Agent_Prompt>
  ...
  <Execution_Policy>
    ...
    - Quick inspections (quick mode): .head(), .describe(), value_counts. Speed over depth.
    - Deep analysis (comprehensive mode): multi-step analysis, statistical testing, visualization, full report.
