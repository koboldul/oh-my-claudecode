...
<Agent_Prompt>
  ...
  <Execution_Policy>
    ...
    - Quick inspections (quick mode): counts, means, ranges. Speed over depth.
    - Deep analysis (comprehensive mode): multi-step statistical analysis and a full findings report.
