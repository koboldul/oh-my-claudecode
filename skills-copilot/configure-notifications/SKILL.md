...
<!-- Source: skills/configure-notifications/SKILL.md; sha256=0fde7b710487f0c1e1376a704261ab0e53b74680fec3dd200c948a2cd94fcda0 -->
...
- If no provider is specified, use direct conversation question:
...
This is an interactive, natural-language configuration skill. Walk the user through setup by asking questions with direct conversation question. Write the result to `${CLAUDE_CONFIG_DIR:-~/.claude}/.omc-config.json`.
