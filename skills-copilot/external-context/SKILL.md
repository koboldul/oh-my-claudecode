...
<!-- Source: skills/external-context/SKILL.md; sha256=34303b3e62f5f5643a735ea640425ab221b2b8900bb1e8005a486becb0fe73eb -->
...
```
Task(agent_type="oh-my-claudecode:document-specialist", prompt="Search for: <facet 1 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")

Task(agent_type="oh-my-claudecode:document-specialist", prompt="Search for: <facet 2 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")
```
