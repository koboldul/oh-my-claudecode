...
<!-- Source: skills/sciomc/SKILL.md; sha256=924954b1a1ddd65004a443e442f19455c5a457d49fa831c74d1ca153147291fd -->
...
Task(agent_type="oh-my-claudecode:scientist", prompt="[RESEARCH_STAGE:1] Investigate...")

// Stage 2 - Standard analysis
Task(agent_type="oh-my-claudecode:scientist", prompt="[RESEARCH_STAGE:2] Analyze...")

// Stage 3 - Complex reasoning
Task(agent_type="oh-my-claudecode:scientist", prompt="[RESEARCH_STAGE:3] Deep analysis of...")
```
...
|-----------------|-------|-------|---------|
| Data gathering | `scientist` (model=quick) | quick | File enumeration, pattern counting, simple lookups |
| Standard analysis | `scientist` | standard | Code analysis, pattern detection, documentation review |
| Complex reasoning | `scientist` | deep | Architecture analysis, cross-cutting concerns, hypothesis validation |
...
Task(agent_type="oh-my-claudecode:scientist", prompt="
...
Task(agent_type="oh-my-claudecode:scientist", prompt="[STAGE:1] Analyze src/api/...")
Task(agent_type="oh-my-claudecode:scientist", prompt="[STAGE:2] Analyze src/utils/...")
Task(agent_type="oh-my-claudecode:scientist", prompt="[STAGE:3] Analyze src/components/...")
```
...
Task(agent_type="oh-my-claudecode:scientist", prompt="[HYPOTHESIS:A] Test if caching improves...")
Task(agent_type="oh-my-claudecode:scientist", prompt="[HYPOTHESIS:B] Test if batching reduces...")
Task(agent_type="oh-my-claudecode:scientist", prompt="[HYPOTHESIS:C] Test if lazy loading helps...")
```
