...
<!-- Source: skills/wiki/SKILL.md; sha256=1e5d60094789a537c5848140a8db4e3919eef8825c86bc379a2884293b7696b4 -->
...
- `fable` — Claude Fable 5 (above Deep); pass it explicitly on the Task call or pin it per agent with `agents.<name>.model`
