...
<!-- Source: skills/ralplan/SKILL.md; sha256=70c98aa2ab0a1577cef3c0e0a9d285eea061885832245bdc1a29bb1fc63b7581 -->
...
2. **User feedback** *(--interactive only)*: If `--interactive` is set, use a direct conversation question to present the draft plan **plus the Principles / Drivers / Options summary** before review (Proceed to review / Request changes / Skip review). Otherwise, automatically proceed to review.
