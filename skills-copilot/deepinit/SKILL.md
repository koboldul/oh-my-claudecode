...
<!-- Source: skills/deepinit/SKILL.md; sha256=99d13c92dfcca1564f3412cabab3afd07d036a13a0fa9813cd336bfc0686fb20 -->
...
```
Task(agent_type="explore", prompt="List all directories recursively. Exclude: node_modules, .git, dist, build, __pycache__, .venv, coverage, .next, .nuxt")
```
