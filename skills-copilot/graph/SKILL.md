...
<!-- Source: skills/graph/SKILL.md; sha256=c0ebe6ddc52436779a04bb0fd9fcd98f694e52e6b156279895825cfb0dd1bf8d -->
...
Run it via the shell execution tool for non-interactive graphs. Progress lines stream as
...
3. **Approval nodes**: if the descriptor contains any `"kind": "human-approval"`
   node, do NOT run it through the shell execution tool (stdin is not interactive there;
