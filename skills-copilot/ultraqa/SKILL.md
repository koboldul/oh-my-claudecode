...
<!-- Source: skills/ultraqa/SKILL.md; sha256=772795925d7f6ad5444f0eccb82153ce0fee44b84da157de5c48c2afaa7f5a30 -->
...
1. **RUN QA**: Execute verification based on goal type
   ...
   - `--interactive`: Use qa-tester for interactive CLI/service testing:
     ```
     Task(agent_type="oh-my-claudecode:qa-tester", prompt="TEST:
...
3. **ARCHITECT DIAGNOSIS**: Spawn architect to analyze failure
   ...
   ```
   Task(agent_type="oh-my-claudecode:architect", prompt="DIAGNOSE FAILURE:
   Goal: [goal type]
...
4. **FIX ISSUES**: Apply architect's recommendations
   ...
   ```
   Task(agent_type="oh-my-claudecode:executor", prompt="FIX:
