...
describe('release-boundary.mjs', () => {
    ...
    it('asserts the final archive surfaces and records tamper-evident byte and content manifests', async () => {
        ...
        const missingHudRuntimePath = writeTarball(root, 'missing-hud-runtime.tgz', releaseTarball(SHA, [], '# fixture\n', ['package/bridge/hud-runtime.mjs']));
        expect(() => assertArchive(missingHudRuntimePath, { version: VERSION, gitHead: SHA })).toThrow('bridge/hud-runtime.mjs');
        const missingCopilotSetupPath = writeTarball(root, 'missing-copilot-hud-setup.tgz', releaseTarball(SHA, [], '# fixture\n', ['package/bridge/copilot-hud-setup.mjs']));
        expect(() => assertArchive(missingCopilotSetupPath, { version: VERSION, gitHead: SHA })).toThrow('bridge/copilot-hud-setup.mjs');
