...
export const COPILOT_HOOKS_JSON_PATH = join(PACKAGE_ROOT, 'hooks', 'copilot-hooks.json');
...
export function referencesCopilotHooksManifest(value) {
    if (typeof value === 'string') {
        const normalized = value.replace(/\\/g, '/');
        return (normalized === './hooks/copilot-hooks.json'
