...
export function assessCopilotCliVersion(detectedVersion) {
    const comparison = compareVersions(toComparableVersion(detectedVersion), toComparableVersion(VERIFIED_COPILOT_CLI_VERSION));
    if (comparison === 0) {
        return {
            status: 'verified',
...
export function detectCopilotCliCompatibility() {
...
//# sourceMappingURL=copilot-cli-compatibility.js.map