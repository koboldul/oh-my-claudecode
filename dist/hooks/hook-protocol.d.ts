...
export declare function formatUnknownError(value: unknown): string;
...
export declare const CLAUDE_SINGLE_CAPABILITIES: HookCapabilities;
export declare const COPILOT_1072_CAPABILITIES: HookCapabilities;
export type NormalizationIssueCode = 'invalid-envelope' | 'invalid-tool-calls' | 'malformed-tool-call' | 'missing-tool-call-id' | 'missing-tool-name' | 'malformed-tool-args' | 'tool-call-serialization-failed' | 'conflicting-duplicate-id';
