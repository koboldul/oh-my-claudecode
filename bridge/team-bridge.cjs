...
function hasGitMetadataAncestor(directory) {
  ...
  let probe = (0, import_path3.resolve)(directory);
  while (true) {
    if ((0, import_fs2.existsSync)((0, import_path3.join)(probe, ".git"))) return true;
    const parent = (0, import_path3.dirname)(probe);
