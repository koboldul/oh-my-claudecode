...
- onboarding: a new collaborator or agent should inherit context by reading, not by asking
...
A new collaborator (human or agent) reading this directory should be able to answer "why does this product direction exist".
```
